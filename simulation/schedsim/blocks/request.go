...
// get_request_time returns the request time
func (r Request) GetRequestTime() float64 {
...
func (rc SimpleReqCreator) NewRequest(serviceTime float64) engine.ReqInterface {
	return &Request{InitTime: engine.GetTime(), ServiceTime: serviceTime, RequestTime: serviceTime}
}
...
func (rc StealableReqCreator) NewRequest(serviceTime float64) engine.ReqInterface {
	return &StealableReq{Request{InitTime: engine.GetTime(), ServiceTime: serviceTime, RequestTime: serviceTime}, false}
}
...
func (rc MonitorReqCreator) NewRequest(serviceTime float64) engine.ReqInterface {
	return &MonitorReq{Request{InitTime: engine.GetTime(), ServiceTime: serviceTime, RequestTime: serviceTime}, 0, 0}
}
